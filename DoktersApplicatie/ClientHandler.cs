...
namespace DoktersApplicatie
{
    public class ClientHandler
    {
        ...
        public async Task<bool> Login(string name, string password)
        {
            ...
            {
                Type = typeof(Connection).FullName, Data = new Connection() {connect = true, password = password},
                Sender = name, Target = "server"
            };
            ...
            return loggedIn;
                ...
                public async Task Run()
                    {
                        ...
                        {
                            Target = this.name, Sender = this.name, Type = typeof(Selection).FullName,
                            Data = new Selection()
                        };
                ...
                private void Parse(string toParse)
                    ...
                    public void SetResistance(Client client, int resistance)
                    {
                        ...
                        {
                            Sender = name, Target = client.Name, Type = typeof(Setting).FullName,
                    ...
                    public void RequestHistory(Client client)
                    {
                        ...
                        {
                            Sender = name, Target = client.Name, Type = typeof(History).FullName,
                    ...
                    public async Task RequestClientsHistory()
                    {
                        ...
                        {
                            Sender = name, Target = name, Type = typeof(ClientsHistory).FullName,
                    ...
                    public void EmergencyStop(bool all, Client client = null)
                    {
                        if (all)
                        {
                            ...
                            {
                                Sender = name, Target = "all", Type = typeof(Setting).FullName,
